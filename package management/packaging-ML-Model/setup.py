...
def list_reqs(fname='requirements.txt'):
    with io.open(os.path.join(pwd, fname), encoding='utf-8') as f:
        return f.read().splitlines() # read whole file with separate lines
...
#Tries to read the README.md file for a detailed description.If the file is not found, falls back to the DESCRIPTION variable
