...
def mlflow_logging(model, X, y, name):
    with mlflow.start_run() as run: # creating mlflow run
        
        run_id = run.info.run_id # get the run id
        mlflow.set_tag("run_id", run_id) #set the tag as run_id for each run
